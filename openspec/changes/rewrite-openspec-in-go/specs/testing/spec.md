...
| TestValidateStrict_CrossSpecConflict | validator/validator_test.go | validation:Strict Validation Mode | validator/change.go |
| TestValidateStrict_MalformedRenamed | validator/validator_test.go | validation:Strict Validation Mode | validator/change.go |
| TestValidateStrict_ModifiedCompleteness | validator/validator_test.go | validation:Strict Validation Mode | validator/change.go |
...
| TestInit_NonInteractive | integration_test.go | cli:Init Command | cmd/init.go |
| TestInit_NoTools | integration_test.go | cli:Init Command | cmd/init.go |
| TestFullLifecycle | integration_test.go | cli:Archive Command, validation:*, archive:* | cmd/*.go, archive/*.go |
| TestView_Dashboard | integration_test.go | dashboard:Terminal Dashboard Rendering | cmd/view.go |
| test_new_version_detected | scripts/upstream-check_test.sh | upstream-tracking:CI-Driven Upstream Check | scripts/upstream-check.sh |
| test_up_to_date | scripts/upstream-check_test.sh | upstream-tracking:CI-Driven Upstream Check | scripts/upstream-check.sh |
| test_issue_created | scripts/upstream-check_test.sh | upstream-tracking:Gap Analysis as GitHub Issue | scripts/upstream-check.sh |
| test_idempotent_issue | scripts/upstream-check_test.sh | upstream-tracking:Gap Analysis as GitHub Issue | scripts/upstream-check.sh |
| test_dry_run | scripts/upstream-check_test.sh | upstream-tracking:Standalone Script | scripts/upstream-check.sh |
